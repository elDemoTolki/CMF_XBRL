"""
actualizar_chile_revenue_2023.py - Actualiza CHILE.SN 2023 con ingresos operacionales
"""
import sqlite3
import os
...
def actualizar_chile_2023():
    """Actualiza revenue de CHILE.SN 2023"""

    print("=" * 100)
    print("ACTUALIZANDO CHILE.SN 2023 - INGRESOS OPERACIONALES")
    ...
    year = 2023
    revenue_mm = 2994872  # Total Ingresos Operacionales 2023 en MM$
    ...
    print()
    print("=" * 100)
    print("[OK] CHILE.SN 2023 actualizado con ingresos operacionales")
    print("Ahora CHILE.SN tiene revenue para 2023-2025")
    print("Falta revenue para 2018-2022")
    print("=" * 100)

if __name__ == '__main__':
    actualizar_chile_2023()
