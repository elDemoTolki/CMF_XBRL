"""
actualizar_chile_revenue_2021.py - Actualiza CHILE.SN 2021 con ingresos operacionales
"""
import sqlite3
import os
...
def actualizar_chile_2021():
    """Actualiza revenue de CHILE.SN 2021"""

    print("=" * 100)
    print("ACTUALIZANDO CHILE.SN 2021 - INGRESOS OPERACIONALES")
    ...
    year = 2021
    revenue_mm = 2199024  # Total Ingresos Operacionales 2021 en MM$
    ...
    print()
    print("=" * 100)
    print("[OK] CHILE.SN 2021 actualizado con ingresos operacionales")
    print("Ahora CHILE.SN tiene revenue para 2021-2025")
    print("Falta revenue para 2018-2020")
    print("=" * 100)

if __name__ == '__main__':
    actualizar_chile_2021()
