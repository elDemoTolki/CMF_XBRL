"""
actualizar_chile_revenue_2020_2021.py - Actualiza CHILE.SN 2020-2021 con ingresos operacionales
"""
import sqlite3
import os
...
INGRESOS_OPERACIONALES = {
    2021: {
        'revenue': 2230257,  # Valor corregido
    },
    2020: {
        'revenue': 1938743,  # Nuevo dato
    },
}
...
def actualizar_chile():
    ...
    print("=" * 100)
    print("ACTUALIZANDO CHILE.SN - INGRESOS OPERACIONALES (2020-2021)")
    ...
    print("Ahora CHILE.SN tiene revenue para 2020-2025")
    print("Falta revenue para 2018-2019")
    print("=" * 100)
